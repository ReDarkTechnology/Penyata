	...
	public struct Vector2 : IEquatable<Vector2>
	{
		...
		public override string ToString()
		{
			return string.Format("({0}, {1})", new object[] {
				Utility.FloatToString(x),
				Utility.FloatToString(y)
			});
		}
		...
		public static implicit operator SDL.SDL_Point(Vector2 v)
		{
		...
		public static implicit operator Vector2(SDL.SDL_Point v)
		{
